...
categoryRouter.post("/", UploadSingleImage("category", "category"), validate.create(), ConfigUploadeFile, controller.CreateNewCategory);
...
categoryRouter.put("/:categoryId", UploadSingleImage("category", "category"), validate.update(), ConfigUploadeFile, controller.UpdateByIdCategory);

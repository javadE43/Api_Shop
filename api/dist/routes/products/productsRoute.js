...
productRoute.post("/", uploadesProductImagesGallery, validate.create(), ConfigUploadeMutiFiles, controller.createProduct);
productRoute.get("/join-pro-cate", validate.validateQueryProductIdAndCategoryId(), controller.insertProductOnCategory);
productRoute.get("/searchtitle", validate.validateQuerySearchProduct(), controller.getProductsByTitle);
